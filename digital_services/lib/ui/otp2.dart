  ...
  String _validator(String value) {
    ...
    if (_formKey.currentState.validate()) {
      bool requestOTP = await AuthService.verifyOTP(
          VerifyOTPModel(
            mobileNumber: Provider.of<AuthProvider>(context, listen: false).phoneNumber.toString(),
            otp: otp.toString()
          ),
          context);
      if (requestOTP == true) { // TODO Fix this using backend logic status codes 400 refuse to auth
        ...
        //Store phone number
        //
        Navigator.of(context).pushNamedAndRemoveUntil(Strings.smsRoute, (Route<dynamic> route) => false);
      }
}
  }
